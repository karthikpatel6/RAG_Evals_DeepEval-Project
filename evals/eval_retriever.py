...
from goldens.goldens_generator import GroqModel  # reuse the wrapper you already built
...
evaluate(
    ...
    async_config=AsyncConfig(
        run_async=True,
        max_concurrent=1,   # sequential — same reasoning as the generator script
        throttle_value=2,   # extra 2s pause between each test case for safety
    ),
)